...
class VacationRequestBlocListener extends StatelessWidget {
  const VacationRequestBlocListener({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocListener<VacationRequestsCubit, VacationRequestsState>(
      listenWhen:
          (previous, current) =>
  ...
  void showSuccessMessage(BuildContext context) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('تم ارسال طلب الاجازة بنجاح '),
