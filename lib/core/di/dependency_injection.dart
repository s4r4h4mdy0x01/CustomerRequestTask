...
Future<void> setupDependencyInjection() async {
  ...
  // borrow request
  getIt.registerLazySingleton<BorrowRequestsRepo>(
    () => BorrowRequestsRepo(getIt()),
  );
  getIt.registerFactory<BorrowRequestsCubit>(
    () => BorrowRequestsCubit(getIt()),
  );
  // Vacation
  getIt.registerLazySingleton<VacationRequestsRepo>(
    () => VacationRequestsRepo(getIt()),
  );
  getIt.registerFactory<VacationRequestsCubit>(
    () => VacationRequestsCubit(getIt()),
  );
}
